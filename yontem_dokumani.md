...
Son güncelleme: 17 Ağustos 2026 (panelin Geçmiş Yangınlar katmanı yeniden üretilebilir 2.748 olaylık kümeye taşındı, Enez Büyükevren yangını artık haritada; boru hattı sayaçları 53.438 ve 2.748 olarak, model ifadesi on üç özellik ve 0.795 AUC olarak, tez cümlesindeki nüfus oranı yaklaşık beş kat olarak güncellendi, hepsi iki dilde. Arayüz: açılış katmanı Tekil Olaylar, footer sadeleşti, Bu Hafta metinleri son kullanıcıya göre yeniden yazıldı. Canlı skorlama modeli hâlâ model_v4'tür)
